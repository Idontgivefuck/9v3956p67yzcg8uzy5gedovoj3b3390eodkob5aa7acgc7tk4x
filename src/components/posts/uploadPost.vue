  ...
  <div class="flex flex-col justify-center items-center dark:text-white">
    <div
      ...
      <div class="flex justify-center">
        <MyButton @clickedd="submitPost" :loading="loading"> Condividi </MyButton>
      </div>
    </div>
  </div>
</template>
